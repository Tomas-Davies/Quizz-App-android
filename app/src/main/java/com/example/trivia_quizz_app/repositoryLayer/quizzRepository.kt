...
class QuizzRepository(private val quizzDao: QuizzDao) {
    ...
    fun fillDefaultData() {
        val defaultQuizzes = listOf(
            Quizz(quizzName = "sport", image = R.drawable.sport_icon),
            Quizz(quizzName = "animals", image = R.drawable.animals_icon),
            Quizz(quizzName = "movies", image = R.drawable.movies_icon),
            Quizz(quizzName = "MIX", image = R.drawable.mix_icon)
        )
